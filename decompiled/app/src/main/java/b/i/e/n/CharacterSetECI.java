...
public enum CharacterSetECI {
    ...
    public static final Map<Integer, CharacterSetECI> K = new HashMap();
    public static final Map<String, CharacterSetECI> L = new HashMap();
    private final String[] otherEncodingNames;
    private final int[] values;

    static {
        CharacterSetECI[] characterSetECIArrValues = values();
        for (int i = 0; i < 27; i++) {
            CharacterSetECI characterSetECI = characterSetECIArrValues[i];
    ...
    public static CharacterSetECI f(int i) throws FormatException {
        if (i < 0 || i >= 900) {
