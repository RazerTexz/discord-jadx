...
/* renamed from: b.h.a.a.b, reason: use source file name */
/* loaded from: classes3.dex */
public class AndroidXBlurImpl implements BlurImpl {
    public static Boolean a;

    /* renamed from: b, reason: collision with root package name */
    public RenderScript f740b;
    ...
    public boolean b(Context context, Bitmap bitmap, float f) {
        ...
        this.c.setRadius(f);
        Allocation allocationCreateFromBitmap = Allocation.createFromBitmap(this.f740b, bitmap, Allocation.MipmapControl.MIPMAP_NONE, 1);
        this.d = allocationCreateFromBitmap;
        this.e = Allocation.createTyped(this.f740b, allocationCreateFromBitmap.getType());
        return true;
    }
    ...
    public void release() {
        ...
        RenderScript renderScript = this.f740b;
