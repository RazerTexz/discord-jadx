...
public final /* data */ class TrackApplicationCommandBrowserOpened implements AnalyticsSchema, TrackBase2, TrackGuild2, TrackChannel2 {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackApplicationCommandBrowserOpened) && Intrinsics3.areEqual(this.previewEnabled, ((TrackApplicationCommandBrowserOpened) other).previewEnabled);
        }
        return true;
    }
    ...
    public String toString() {
        return outline.D(outline.U("TrackApplicationCommandBrowserOpened(previewEnabled="), this.previewEnabled, ")");
    }
}
