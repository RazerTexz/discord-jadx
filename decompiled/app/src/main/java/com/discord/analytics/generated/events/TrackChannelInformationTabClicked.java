...
public final /* data */ class TrackChannelInformationTabClicked implements AnalyticsSchema, TrackBase2, TrackGuild2, TrackChannel2 {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackChannelInformationTabClicked) && Intrinsics3.areEqual(this.tab, ((TrackChannelInformationTabClicked) other).tab);
        }
        return true;
    }
    ...
    public String toString() {
        return outline.E(outline.U("TrackChannelInformationTabClicked(tab="), this.tab, ")");
    }
}
