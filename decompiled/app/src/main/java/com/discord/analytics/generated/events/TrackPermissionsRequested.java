...
public final /* data */ class TrackPermissionsRequested implements AnalyticsSchema, TrackBase2 {
    ...
    public String toString() {
        return outline.E(outline.U("TrackPermissionsRequested(type="), this.type, ")");
    }
}
