...
public final /* data */ class TrackBotQuarantined implements AnalyticsSchema, TrackBase2 {
    ...
    public String toString() {
        return outline.G(outline.U("TrackBotQuarantined(botId="), this.botId, ")");
    }
}
