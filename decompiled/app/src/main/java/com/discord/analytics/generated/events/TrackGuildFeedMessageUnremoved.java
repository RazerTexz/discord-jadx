...
public final /* data */ class TrackGuildFeedMessageUnremoved implements AnalyticsSchema, TrackBase2, TrackChannel2, TrackGuild2 {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackGuildFeedMessageUnremoved) && Intrinsics3.areEqual(this.messageId, ((TrackGuildFeedMessageUnremoved) other).messageId);
        }
        return true;
    }
    ...
    public String toString() {
        return outline.G(outline.U("TrackGuildFeedMessageUnremoved(messageId="), this.messageId, ")");
    }
}
