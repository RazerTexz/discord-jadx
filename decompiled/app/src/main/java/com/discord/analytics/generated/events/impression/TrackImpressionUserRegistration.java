...
public final /* data */ class TrackImpressionUserRegistration implements AnalyticsSchema, TrackBase2, TrackGuild2, TrackChannel2, TrackLocationMetadata2, TrackImpressionMetadata2 {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackImpressionUserRegistration) && Intrinsics3.areEqual(this.step, ((TrackImpressionUserRegistration) other).step);
        }
        return true;
    }
    ...
    public String toString() {
        return outline.E(outline.U("TrackImpressionUserRegistration(step="), this.step, ")");
    }
