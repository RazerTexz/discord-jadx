...
public final /* data */ class TrackNudgeDisplayed implements AnalyticsSchema, TrackBase2, TrackLocationMetadata2 {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackNudgeDisplayed) && Intrinsics3.areEqual(this.stickerId, ((TrackNudgeDisplayed) other).stickerId);
        }
        return true;
    }
    ...
    public String toString() {
        return outline.G(outline.U("TrackNudgeDisplayed(stickerId="), this.stickerId, ")");
    }
}
