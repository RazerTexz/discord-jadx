...
public final /* data */ class TrackNavDrawerOpened implements AnalyticsSchema, TrackBase2 {
    ...
    public String toString() {
        StringBuilder sbU = outline.U("TrackNavDrawerOpened(drawer=");
