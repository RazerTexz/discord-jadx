...
public final /* data */ class TrackImpressionUserLogin implements AnalyticsSchema, TrackBase2, TrackGuild2, TrackChannel2, TrackLocationMetadata2, TrackImpressionMetadata2 {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackImpressionUserLogin) && Intrinsics3.areEqual(this.passwordOnly, ((TrackImpressionUserLogin) other).passwordOnly);
        }
        return true;
    }
    ...
    public String toString() {
        return outline.D(outline.U("TrackImpressionUserLogin(passwordOnly="), this.passwordOnly, ")");
    }
