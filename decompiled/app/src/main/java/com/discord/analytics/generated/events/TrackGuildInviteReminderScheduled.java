...
public final /* data */ class TrackGuildInviteReminderScheduled implements AnalyticsSchema, TrackBase2 {
    ...
    public String toString() {
        return outline.G(outline.U("TrackGuildInviteReminderScheduled(guildId="), this.guildId, ")");
    }
}
