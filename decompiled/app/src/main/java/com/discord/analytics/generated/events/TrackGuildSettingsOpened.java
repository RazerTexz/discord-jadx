...
public final /* data */ class TrackGuildSettingsOpened implements AnalyticsSchema, TrackBase2, TrackGuild2, TrackChannel2 {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackGuildSettingsOpened) && Intrinsics3.areEqual(this.settingsVersion, ((TrackGuildSettingsOpened) other).settingsVersion);
        }
        return true;
    }
    ...
    public String toString() {
        return outline.E(outline.U("TrackGuildSettingsOpened(settingsVersion="), this.settingsVersion, ")");
    }
}
