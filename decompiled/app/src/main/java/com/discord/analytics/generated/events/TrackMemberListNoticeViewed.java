...
public final /* data */ class TrackMemberListNoticeViewed implements AnalyticsSchema, TrackBase2, TrackGuild2, TrackChannel2 {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackMemberListNoticeViewed) && Intrinsics3.areEqual(this.noticeType, ((TrackMemberListNoticeViewed) other).noticeType);
        }
        return true;
    }
    ...
    public String toString() {
        return outline.E(outline.U("TrackMemberListNoticeViewed(noticeType="), this.noticeType, ")");
    }
}
