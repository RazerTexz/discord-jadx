...
public final /* data */ class TrackRichChatTextBoxToggled implements AnalyticsSchema, TrackBase2 {
    ...
    public String toString() {
        return outline.D(outline.U("TrackRichChatTextBoxToggled(isEnabled="), this.isEnabled, ")");
    }
}
