...
public final /* data */ class TrackIarLeaveGuildButtonClicked implements AnalyticsSchema, TrackBase2, TrackLocationMetadata2, TrackGuild2, TrackChannel2 {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackIarLeaveGuildButtonClicked) && Intrinsics3.areEqual(this.reportId, ((TrackIarLeaveGuildButtonClicked) other).reportId);
        }
        return true;
    }
    ...
    public String toString() {
        return outline.G(outline.U("TrackIarLeaveGuildButtonClicked(reportId="), this.reportId, ")");
    }
}
