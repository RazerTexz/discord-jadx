...
public final /* data */ class TrackRoleSubscriptionListingDeleted implements AnalyticsSchema, TrackBase2, TrackGuild2 {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics3.areEqual(this.roleSubscriptionListingId, trackRoleSubscriptionListingDeleted.roleSubscriptionListingId) && Intrinsics3.areEqual(this.name, trackRoleSubscriptionListingDeleted.name) && Intrinsics3.areEqual(this.roleSubscriptionGroupListingId, trackRoleSubscriptionListingDeleted.roleSubscriptionGroupListingId);
    }
    ...
    public String toString() {
        StringBuilder sbU = outline.U("TrackRoleSubscriptionListingDeleted(roleSubscriptionListingId=");
