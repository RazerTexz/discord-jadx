...
public final /* data */ class TrackChatInputComponentViewed implements AnalyticsSchema, TrackBase2 {
    ...
    public String toString() {
        return outline.E(outline.U("TrackChatInputComponentViewed(type="), this.type, ")");
    }
}
