...
public final /* data */ class TrackSearchOpened implements AnalyticsSchema, TrackBase2, TrackGuild2, TrackChannel2 {
    ...
    public String toString() {
        StringBuilder sbU = outline.U("TrackSearchOpened(searchType=");
