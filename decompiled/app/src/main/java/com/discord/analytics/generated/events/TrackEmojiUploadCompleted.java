...
public final /* data */ class TrackEmojiUploadCompleted implements AnalyticsSchema, TrackBase2, TrackGuild2 {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackEmojiUploadCompleted) && Intrinsics3.areEqual(this.uploadId, ((TrackEmojiUploadCompleted) other).uploadId);
        }
        return true;
    }
    ...
    public String toString() {
        return outline.E(outline.U("TrackEmojiUploadCompleted(uploadId="), this.uploadId, ")");
    }
}
