...
public final class GuildScheduledEventDescriptionParser3 extends Lambda implements Function0<Parser<MessageRenderContext, Node<MessageRenderContext>, MessageParseState>> {
    public static final GuildScheduledEventDescriptionParser3 INSTANCE = new GuildScheduledEventDescriptionParser3();

    public GuildScheduledEventDescriptionParser3() {
        super(0);
    }
