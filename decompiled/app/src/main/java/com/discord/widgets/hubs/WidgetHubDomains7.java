...
public final class WidgetHubDomains7 extends Lambda implements Function2<LayoutInflater, ViewGroup, WidgetHubDomains4> {
    ...
    public WidgetHubDomains7(WidgetHubDomains widgetHubDomains) {
        super(2);
