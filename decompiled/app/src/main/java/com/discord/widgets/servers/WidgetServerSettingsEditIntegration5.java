...
public final class WidgetServerSettingsEditIntegration5 extends Lambda implements Function0<List<? extends CheckedSetting>> {
    ...
    public final List<? extends CheckedSetting> invoke2() {
        return Collections2.listOf((Object[]) new CheckedSetting[]{WidgetServerSettingsEditIntegration.access$getBinding$p(this.this$0).f, WidgetServerSettingsEditIntegration.access$getBinding$p(this.this$0).e});
    }
}
