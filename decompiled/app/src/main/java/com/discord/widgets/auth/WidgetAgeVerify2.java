...
/* renamed from: com.discord.widgets.auth.WidgetAgeVerify$configureBirthdayInput$1$$special$$inlined$apply$lambda$1, reason: use source file name */
/* loaded from: classes2.dex */
public final class WidgetAgeVerify2 extends Lambda implements Function1<Long, Unit> {
    public final /* synthetic */ WidgetAgeVerify.AnonymousClass1 this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WidgetAgeVerify2(WidgetAgeVerify.AnonymousClass1 anonymousClass1) {
        super(1);
