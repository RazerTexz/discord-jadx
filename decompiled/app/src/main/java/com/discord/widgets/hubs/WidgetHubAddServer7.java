...
public final class WidgetHubAddServer7 extends Lambda implements Function0<AnalyticsSchema> {
    public static final WidgetHubAddServer7 INSTANCE = new WidgetHubAddServer7();

    public WidgetHubAddServer7() {
        super(0);
    }
