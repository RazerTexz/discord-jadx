...
public final class WidgetServerSettingsAuditLog5 extends Lambda implements Function0<AnalyticsSchema> {
    public static final WidgetServerSettingsAuditLog5 INSTANCE = new WidgetServerSettingsAuditLog5();

    public WidgetServerSettingsAuditLog5() {
        super(0);
    }
