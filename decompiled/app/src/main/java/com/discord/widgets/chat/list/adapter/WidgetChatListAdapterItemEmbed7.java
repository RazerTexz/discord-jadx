...
public final class WidgetChatListAdapterItemEmbed7 extends Lambda implements Function1<String, Unit> {
    public final /* synthetic */ WidgetChatListAdapter.EventHandler $eventHandler;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WidgetChatListAdapterItemEmbed7(WidgetChatListAdapter.EventHandler eventHandler) {
        super(1);
