...
public final class WidgetUserPhoneVerify7 extends Lambda implements Function0<AnalyticsSchema> {
    public static final WidgetUserPhoneVerify7 INSTANCE = new WidgetUserPhoneVerify7();

    public WidgetUserPhoneVerify7() {
        super(0);
    }
