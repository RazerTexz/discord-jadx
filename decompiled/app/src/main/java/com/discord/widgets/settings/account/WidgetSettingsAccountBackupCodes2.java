...
public final class WidgetSettingsAccountBackupCodes2 extends Lambda implements Function2<Context, String, Unit> {
    public final /* synthetic */ WidgetSettingsAccountBackupCodes this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WidgetSettingsAccountBackupCodes2(WidgetSettingsAccountBackupCodes widgetSettingsAccountBackupCodes) {
        super(2);
