    ...
    private void onMeasureExactFormat(int i, int i2) {
        ...
        while (i13 < childCount) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                int iMeasureChildForCells = measureChildForCells(childAt, i12, layoutParams.isOverflowButton ? 1 : i10, childMeasureSpec, paddingBottom);
        ...
        if (i10 <= 0 || j == 0 || (i10 >= i14 - 1 && !z10 && iMax2 <= 1)) {
            z3 = z2;
        } else {
