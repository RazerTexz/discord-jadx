    ...
    */
    public void onLayout(boolean z2, int i, int i2, int i3, int i4) {
        ...
        if (!shouldLayout(this.mNavButtonView)) {
            ...
            if (z3) {
                iLayoutChildRight = layoutChildRight(this.mNavButtonView, i20, iArr, iMin);
                iLayoutChildLeft = paddingLeft;
                ...
                int iMin2 = Math.min(iLayoutChildRight, i20 - currentContentInsetRight);
                ...
                if (zShouldLayout) {
                    ...
                    i5 = paddingRight;
                    measuredHeight = this.mTitleTextView.getMeasuredHeight() + ((ViewGroup.MarginLayoutParams) layoutParams).topMargin + ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin + 0;
                }
                if (zShouldLayout2) {
                    i6 = width;
                } else {
                ...
                if (!zShouldLayout || zShouldLayout2) {
                    ...
                    if (i7 == 48) {
                        ...
                        if (iMax2 < i21 + i22) {
                            ...
                            int i25 = this.mTitleMarginBottom;
                            if (i23 < i24 + i25) {
                    ...
                    if (!z3) {
                        ...
                        if (zShouldLayout2) {
                            int i27 = paddingTop + ((ViewGroup.MarginLayoutParams) ((LayoutParams) this.mSubtitleTextView.getLayoutParams())).topMargin;
                            int measuredWidth2 = this.mSubtitleTextView.getMeasuredWidth() + iMax;
                            this.mSubtitleTextView.layout(iMax, i27, measuredWidth2, this.mSubtitleTextView.getMeasuredHeight() + i27);
                        ...
                        for (i17 = 0; i17 < size; i17++) {
                            iMax = layoutChildLeft(this.mTempViews.get(i17), iMax, iArr, i10);
                        }
                        int i28 = i10;
                        addCustomViewsWithGravity(this.mTempViews, 5);
                        size2 = this.mTempViews.size();
                        for (i18 = 0; i18 < size2; i18++) {
                            iMin2 = layoutChildRight(this.mTempViews.get(i18), iMin2, iArr, i28);
                        }
                        addCustomViewsWithGravity(this.mTempViews, 1);
                        int viewListMeasuredWidth = getViewListMeasuredWidth(this.mTempViews, iArr);
                        i19 = ((((i6 - i8) - i5) / 2) + i8) - (viewListMeasuredWidth / 2);
                        int i29 = viewListMeasuredWidth + i19;
                        if (i19 >= iMax) {
                            iMax = i29 > iMin2 ? i19 - (i29 - iMin2) : i19;
                        }
                        size3 = this.mTempViews.size();
                        while (i11 < size3) {
                            iMax = layoutChildLeft(this.mTempViews.get(i11), iMax, iArr, i28);
                            i11++;
                        }
                    ...
                    if (zShouldLayout2) {
                        ...
                        this.mSubtitleTextView.layout(iMin2 - this.mSubtitleTextView.getMeasuredWidth(), i31, iMin2, this.mSubtitleTextView.getMeasuredHeight() + i31);
                        i16 = iMin2 - this.mTitleMarginEnd;
                    } else {
                        i16 = iMin2;
                    }
                    if (z4) {
                ...
                i19 = ((((i6 - i8) - i5) / 2) + i8) - (viewListMeasuredWidth2 / 2);
                int i292 = viewListMeasuredWidth2 + i19;
                if (i19 >= iMax) {
                }
                size3 = this.mTempViews.size();
                while (i11 < size3) {
        ...
        int iMin22 = Math.min(iLayoutChildRight, i20 - currentContentInsetRight2);
        if (shouldLayout(this.mExpandedActionView)) {
        }
        if (shouldLayout(this.mLogoView)) {
        }
        ...
        i19 = ((((i6 - i8) - i5) / 2) + i8) - (viewListMeasuredWidth22 / 2);
        int i2922 = viewListMeasuredWidth22 + i19;
        if (i19 >= iMax) {
        }
        size3 = this.mTempViews.size();
        while (i11 < size3) {
