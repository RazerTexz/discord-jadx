...
public class PathParser {
    ...
    public static Path createPathFromPathData(String str) {
        ...
        try {
            ...
            throw new RuntimeException(outline.w("Error in parsing ", str), e);
        }
    }
    ...
    */
    ...
    private static float[] getFloats(String str) {
        ...
        try {
            ...
            throw new RuntimeException(outline.y("error in parsing \"", str, "\""), e);
        }
    }
    ...
    */
    ...
    public static class PathDataNode {
        ...
        private static void drawArc(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z2, boolean z3) {
            ...
            double dAtan22 = Math.atan2(d12 - d2, d11 - d) - dAtan2;
            if (z3 != (dAtan22 >= 0.0d)) {
                dAtan22 = dAtan22 > 0.0d ? dAtan22 - 6.283185307179586d : dAtan22 + 6.283185307179586d;
            }
            double d21 = d * d6;
            double d22 = d2 * d8;
            arcToBezier(path, (d21 * dCos) - (d22 * dSin), (d22 * dCos) + (d21 * dSin), d6, d8, d3, d5, radians, dAtan2, dAtan22);
        }
