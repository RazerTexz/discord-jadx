...
public final class TimeUtils {
    ...
    private static int accumField(int i, int i2, boolean z2, int i3) {
        if (i > 99 || (z2 && i3 >= 3)) {
            return i2 + 3;
        }
        if (i > 9 || (z2 && i3 >= 2)) {
    ...
    private static int formatDurationLocked(long j, int i) {
        ...
        int iPrintField2 = printField(cArr, i3, 'h', iPrintField, iPrintField != i10, z2 ? 2 : 0);
        int iPrintField3 = printField(cArr, i5, 'm', iPrintField2, iPrintField2 != i10, z2 ? 2 : 0);
        int iPrintField4 = printField(cArr, i4, 's', iPrintField3, iPrintField3 != i10, z2 ? 2 : 0);
        int iPrintField5 = printField(cArr, i8, 'm', iPrintField4, true, (!z2 || iPrintField4 == i10) ? 0 : 3);
        cArr[iPrintField5] = 's';
        return iPrintField5 + 1;
    }

    private static int printField(char[] cArr, int i, char c, int i2, boolean z2, int i3) {
        int i4;
        if (!z2 && i <= 0) {
            return i2;
        }
