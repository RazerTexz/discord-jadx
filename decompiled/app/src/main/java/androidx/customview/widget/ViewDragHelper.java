        ...
        if (actionMasked == 2) {
            ...
            while (i2 < pointerCount) {
                ...
                if (isValidPointerForActionMove(pointerId2)) {
                    ...
                    float f = x4 - this.mInitialMotionX[pointerId2];
                    float f2 = y4 - this.mInitialMotionY[pointerId2];
            ...
            if (actionMasked != 2) {
                if (actionMasked != 3) {
                    if (actionMasked == 5) {
                        ...
                        } else if (i3 == 2 && (viewFindTopChildUnder = findTopChildUnder((int) x3, (int) y3)) == this.mCapturedView) {
                ...
                for (int i6 = 0; i6 < pointerCount; i6++) {
                    ...
                    if (isValidPointerForActionMove(pointerId3)) {
                        ...
                        float f = x4 - this.mInitialMotionX[pointerId3];
                        float f2 = y4 - this.mInitialMotionY[pointerId3];
                        View viewFindTopChildUnder3 = findTopChildUnder((int) x4, (int) y4);
                        boolean z3 = viewFindTopChildUnder3 != null && checkTouchSlop(viewFindTopChildUnder3, f, f2);
                        if (z3) {
                            ...
                            if (this.mDragState == 1 || (z3 && tryCaptureViewForDrag(viewFindTopChildUnder3, pointerId3))) {
                                break;
                            }
                        }
                    }
