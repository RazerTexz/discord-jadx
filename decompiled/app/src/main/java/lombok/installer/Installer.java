...
/* loaded from: discord:lombok/installer/Installer.SCL.lombok */
public class Installer {
    ...
    public static boolean isSelf(String jar) throws IOException {
        ...
        File b2 = new File(self).getAbsoluteFile();
        try {
    ...
    /* loaded from: discord:lombok/installer/Installer$GraphicalInstallerApp.SCL.lombok */
    ...
    /* loaded from: discord:lombok/installer/Installer$CommandLineInstallerApp.SCL.lombok */
    ...
    /* loaded from: discord:lombok/installer/Installer$CommandLineUninstallerApp.SCL.lombok */
    ...
    /* loaded from: discord:lombok/installer/Installer$1.SCL.lombok */
    ...
    /* loaded from: discord:lombok/installer/Installer$CmdArgs.SCL.lombok */
