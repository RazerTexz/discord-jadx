...
/* loaded from: discord:lombok/javac/CapturingDiagnosticListener.SCL.lombok */
public class CapturingDiagnosticListener implements DiagnosticListener<JavaFileObject> {
    ...
    /* loaded from: discord:lombok/javac/CapturingDiagnosticListener$CompilerMessage.SCL.lombok */
