...
/* loaded from: discord:lombok/javac/handlers/HandleConstructor.SCL.lombok */
public class HandleConstructor {
    private static /* synthetic */ int[] $SWITCH_TABLE$javax$lang$model$type$TypeKind;

    /* loaded from: discord:lombok/javac/handlers/HandleConstructor$SkipIfConstructorExists.SCL.lombok */
    ...
    /* loaded from: discord:lombok/javac/handlers/HandleConstructor$HandleNoArgsConstructor.SCL.lombok */
    ...
    /* loaded from: discord:lombok/javac/handlers/HandleConstructor$HandleRequiredArgsConstructor.SCL.lombok */
    ...
    /* loaded from: discord:lombok/javac/handlers/HandleConstructor$HandleAllArgsConstructor.SCL.lombok */
    ...
    public static JCTree.JCMethodDecl createConstructor(AccessLevel level, List<JCTree.JCAnnotation> onConstructor, JavacNode typeNode, List<JavacNode> fieldsToParam, boolean forceDefaults, JavacNode source) {
        ...
        boolean isEnum = (typeNode.get().mods.flags & Permission.EMBED_LINKS) != 0;
        if (isEnum) {
