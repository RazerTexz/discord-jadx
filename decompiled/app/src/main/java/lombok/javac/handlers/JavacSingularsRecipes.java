...
/* loaded from: discord:lombok/javac/handlers/JavacSingularsRecipes.SCL.lombok */
public class JavacSingularsRecipes {
    ...
    /* loaded from: discord:lombok/javac/handlers/JavacSingularsRecipes$ExpressionMaker.SCL.lombok */
    public interface ExpressionMaker {
        JCTree.JCExpression make();
    }

    /* loaded from: discord:lombok/javac/handlers/JavacSingularsRecipes$StatementMaker.SCL.lombok */
    ...
    /* loaded from: discord:lombok/javac/handlers/JavacSingularsRecipes$SingularData.SCL.lombok */
    public static final class SingularData {
        ...
        static /* synthetic */ JavacNode access$2(SingularData singularData) {
            return singularData.annotation;
        }

        static /* synthetic */ Name access$1(SingularData singularData) {
            return singularData.singularName;
        }

        static /* synthetic */ Name access$0(SingularData singularData) {
    ...
    /* loaded from: discord:lombok/javac/handlers/JavacSingularsRecipes$JavacSingularizer.SCL.lombok */
    public static abstract class JavacSingularizer {
        ...
        public abstract void generateMethods(CheckerFrameworkVersion checkerFrameworkVersion, SingularData singularData, boolean z2, JavacNode javacNode, JCTree jCTree, boolean z3, ExpressionMaker expressionMaker, StatementMaker statementMaker, AccessLevel accessLevel);
        ...
        public List<Name> listMethodsToBeGenerated(SingularData data, JavacNode builderType) {
            Name p = SingularData.access$0(data);
            Name s2 = SingularData.access$1(data);
        ...
        /* loaded from: discord:lombok/javac/handlers/JavacSingularsRecipes$JavacSingularizer$1.SCL.lombok */
        ...
        /* loaded from: discord:lombok/javac/handlers/JavacSingularsRecipes$JavacSingularizer$2.SCL.lombok */
