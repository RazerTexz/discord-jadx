...
/* loaded from: discord:lombok/javac/JavacTransformer.SCL.lombok */
public class JavacTransformer {
    ...
    /* loaded from: discord:lombok/javac/JavacTransformer$AnnotationVisitor.SCL.lombok */
    private class AnnotationVisitor extends JavacASTAdapter {
        ...
        public void visitAnnotationOnType(JCTree.JCClassDecl type, JavacNode annotationNode, JCTree.JCAnnotation annotation) {
            ...
            JavacTransformer.access$0(JavacTransformer.this).handleAnnotation(top, annotationNode, annotation, this.priority);
        }
