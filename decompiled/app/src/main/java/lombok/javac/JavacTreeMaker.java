...
/* loaded from: discord:lombok/javac/JavacTreeMaker.SCL.lombok */
public class JavacTreeMaker {
    ...
    /* loaded from: discord:lombok/javac/JavacTreeMaker$Case12.SCL.lombok */
    ...
    /* loaded from: discord:lombok/javac/JavacTreeMaker$FieldId.SCL.lombok */
    private static final class FieldId<J> {
        private final Class<?> owner;
        private final String name;
        private final Class<J> fieldType;

        static /* synthetic */ Class access$1(FieldId fieldId) {
            return fieldId.owner;
        }

        static /* synthetic */ String access$2(FieldId fieldId) {
            return fieldId.name;
        }

        static /* synthetic */ Class access$0(FieldId fieldId) {
    ...
    /* loaded from: discord:lombok/javac/JavacTreeMaker$MethodId.SCL.lombok */
    private static final class MethodId<J> {
        ...
        static /* synthetic */ Class access$1(MethodId methodId) {
            return methodId.owner;
        }

        static /* synthetic */ String access$2(MethodId methodId) {
            return methodId.name;
        }

        static /* synthetic */ Class access$0(MethodId methodId) {
            return methodId.returnType;
        }

        static /* synthetic */ Class[] access$3(MethodId methodId) {
            return methodId.paramTypes;
        }
    ...
    /* loaded from: discord:lombok/javac/JavacTreeMaker$SchroedingerType.SCL.lombok */
    ...
    /* loaded from: discord:lombok/javac/JavacTreeMaker$TypeTag.SCL.lombok */
    ...
    /* loaded from: discord:lombok/javac/JavacTreeMaker$TreeTag.SCL.lombok */
    ...
    private static <J> J get(Object obj, FieldId<J> fieldId) {
        try {
            return (J) FieldId.access$0(fieldId).cast(getFromCache((FieldId<?>) fieldId).get(obj));
        } catch (IllegalAccessException e) {
            throw Javac.sneakyThrow(e);
        }
    }
    ...
    private static Object addToCache(FieldId<?> f) {
        for (Field field : FieldId.access$1(f).getDeclaredFields()) {
            if (FieldId.access$2(f).equals(field.getName())) {
    ...
    static /* synthetic */ Object access$0(Object obj, MethodId methodId, Object[] objArr) {
    ...
    private static <J> J invokeAny(Object obj, MethodId<J> methodId, Object... objArr) throws SecurityException {
        ...
        try {
            ...
            return (J) MethodId.access$0(methodId).cast(fromCache.invoke(obj, objArr));
        } catch (IllegalAccessException e) {
            throw Javac.sneakyThrow(e);
        } catch (IllegalArgumentException e2) {
