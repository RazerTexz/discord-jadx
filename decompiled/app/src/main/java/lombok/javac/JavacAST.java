...
/* loaded from: discord:lombok/javac/JavacAST.SCL.lombok */
public class JavacAST extends AST<JavacAST, JavacNode, JCTree> {
    ...
    @Override // lombok.core.AST
    protected /* bridge */ /* synthetic */ LombokNode buildTree(JCTree jCTree, AST.Kind kind) {
        return buildTree2(jCTree, kind);
    }
    ...
    /* loaded from: discord:lombok/javac/JavacAST$ErrorLog.SCL.lombok */
    ...
    /* loaded from: discord:lombok/javac/JavacAST$JdkBefore9.SCL.lombok */
    ...
    /* loaded from: discord:lombok/javac/JavacAST$Jdk9Plus.SCL.lombok */
