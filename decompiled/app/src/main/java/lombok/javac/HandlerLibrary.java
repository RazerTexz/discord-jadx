...
/* loaded from: discord:lombok/javac/HandlerLibrary.SCL.lombok */
public class HandlerLibrary {
    ...
    /* loaded from: discord:lombok/javac/HandlerLibrary$VisitorContainer.SCL.lombok */
    ...
    /* loaded from: discord:lombok/javac/HandlerLibrary$AnnotationHandlerContainer.SCL.lombok */
    ...
    public void handleAnnotation(JCTree.JCCompilationUnit unit, JavacNode node, JCTree.JCAnnotation annotation, long priority) {
        ...
        for (AnnotationHandlerContainer<?> container : containers) {
            try {
                ...
                javacError(String.format("Lombok annotation handler %s failed on " + sourceName, AnnotationHandlerContainer.access$1(container).getClass()), t);
            }
        }
    }
    ...
    public void callASTVisitors(JavacAST ast, long priority) {
        for (VisitorContainer container : this.visitorHandlers) {
            try {
                ...
                javacError(String.format("Lombok visitor handler %s failed", VisitorContainer.access$0(container).getClass()), t);
            }
        }
    }
}
