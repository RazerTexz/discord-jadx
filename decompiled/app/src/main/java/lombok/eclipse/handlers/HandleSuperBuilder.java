...
/* loaded from: discord:lombok/eclipse/handlers/HandleSuperBuilder.SCL.lombok */
public class HandleSuperBuilder extends EclipseAnnotationHandler<SuperBuilder> {
    ...
    /* loaded from: discord:lombok/eclipse/handlers/HandleSuperBuilder$SuperBuilderJob.SCL.lombok */
    class SuperBuilderJob extends HandleBuilder.BuilderJob {
        ...
        static /* synthetic */ void access$0(SuperBuilderJob superBuilderJob, TypeParameter[] typeParameterArr) {
            superBuilderJob.builderTypeParams_ = typeParameterArr;
        }
    ...
    public void handle(AnnotationValues<SuperBuilder> annotation, Annotation ast, EclipseNode annotationNode) throws SecurityException {
        ...
        if (HandlerUtil.checkName("buildMethodName", job.buildMethodName, annotationNode)) {
            ...
            TypeParameter b2 = new TypeParameter();
            b2.name = builderGenericName.toCharArray();
            b2.type = EclipseHandlerUtil.cloneSelfType(job.parentType, job.source);
            paddedTypeParameters[paddedTypeParameters.length - 1] = b2;
            SuperBuilderJob.access$0(job, paddedTypeParameters);
    ...
    private void generateBuilderBasedConstructor(HandleBuilder.BuilderJob job, boolean callBuilderBasedSuperConstructor) {
        ...
        for (HandleBuilder.BuilderFieldData fieldNode : job.builderFields) {
            ...
            int s2 = (int) (p >> 32);
            int e = (int) p;
            fieldInThis.receiver = new ThisReference(s2, e);
            if (fieldNode.singularData != null && fieldNode.singularData.getSingularizer() != null) {
                ...
                long[] positions = {p, p};
                qualifiedNameReference = new QualifiedNameReference((char[][]) r0, positions, s2, e);
            }
            ...
            if (fieldNode.nameOfSetFlag != null) {
                ...
                long[] positions2 = {p, p};
                QualifiedNameReference setVariableInBuilderRef = new QualifiedNameReference((char[][]) r02, positions2, s2, e);
                ...
                IfStatement ifBlockForDefault = new IfStatement(setVariableInBuilderRef, assignment, new Assignment(fieldInThis, defaultMethodCall, (int) p), s2, e);
    ...
    /* loaded from: discord:lombok/eclipse/handlers/HandleSuperBuilder$1.SCL.lombok */
    ...
    /* loaded from: discord:lombok/eclipse/handlers/HandleSuperBuilder$2.SCL.lombok */
