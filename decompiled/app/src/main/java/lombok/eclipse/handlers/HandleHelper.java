...
/* loaded from: discord:lombok/eclipse/handlers/HandleHelper.SCL.lombok */
public class HandleHelper extends EclipseAnnotationHandler<Helper> {
    ...
    public void handle(AnnotationValues<Helper> annotation, Annotation ast, EclipseNode annotationNode) {
        ...
        char[] helperName = new char[((TypeDeclaration) statement).name.length + 1];
    ...
    /* loaded from: discord:lombok/eclipse/handlers/HandleHelper$1.SCL.lombok */
