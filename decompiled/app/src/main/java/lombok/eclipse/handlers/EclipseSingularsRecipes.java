...
/* loaded from: discord:lombok/eclipse/handlers/EclipseSingularsRecipes.SCL.lombok */
public class EclipseSingularsRecipes {
    ...
    /* loaded from: discord:lombok/eclipse/handlers/EclipseSingularsRecipes$StatementMaker.SCL.lombok */
    public interface StatementMaker {
        /* renamed from: make */
        Statement mo186make();
    }

    /* loaded from: discord:lombok/eclipse/handlers/EclipseSingularsRecipes$TypeReferenceMaker.SCL.lombok */
    ...
    /* loaded from: discord:lombok/eclipse/handlers/EclipseSingularsRecipes$SingularData.SCL.lombok */
    public static final class SingularData {
        ...
        static /* synthetic */ char[] access$1(SingularData singularData) {
            return singularData.singularName;
        }

        static /* synthetic */ char[] access$0(SingularData singularData) {
            return singularData.pluralName;
        }
    ...
    /* loaded from: discord:lombok/eclipse/handlers/EclipseSingularsRecipes$EclipseSingularizer.SCL.lombok */
    public static abstract class EclipseSingularizer {
        ...
        public abstract void generateMethods(CheckerFrameworkVersion checkerFrameworkVersion, SingularData singularData, boolean z2, EclipseNode eclipseNode, boolean z3, TypeReferenceMaker typeReferenceMaker, StatementMaker statementMaker, AccessLevel accessLevel);
        ...
        public List<char[]> listFieldsToBeGenerated(SingularData data, EclipseNode builderType) {
            return Collections.singletonList(SingularData.access$0(data));
        }
        ...
        public List<char[]> listMethodsToBeGenerated(SingularData data, EclipseNode builderType) {
            char[] p = SingularData.access$0(data);
            char[] s2 = SingularData.access$1(data);
        ...
        /* loaded from: discord:lombok/eclipse/handlers/EclipseSingularsRecipes$EclipseSingularizer$1.SCL.lombok */
        ...
        /* loaded from: discord:lombok/eclipse/handlers/EclipseSingularsRecipes$EclipseSingularizer$2.SCL.lombok */
        ...
        protected void nullBehaviorize(EclipseNode typeNode, SingularData data, List<Statement> statements, Argument arg) {
            ...
            if (ignoreNullCollections) {
                ...
                b2.statements = (Statement[]) statements.toArray(new Statement[statements.size()]);
                statements.clear();
                statements.add(new IfStatement(equalExpression, b2, 0, 0));
