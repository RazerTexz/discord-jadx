...
/* loaded from: discord:lombok/eclipse/TransformEclipseAST.SCL.lombok */
public class TransformEclipseAST {
    ...
    /* loaded from: discord:lombok/eclipse/TransformEclipseAST$State.SCL.lombok */
    private enum State {
        DIET,
        FULL;
    ...
    /* loaded from: discord:lombok/eclipse/TransformEclipseAST$AnnotationVisitor.SCL.lombok */
