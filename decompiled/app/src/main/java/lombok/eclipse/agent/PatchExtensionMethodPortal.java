...
/* loaded from: discord:lombok/eclipse/agent/PatchExtensionMethodPortal.SCL.lombok */
public class PatchExtensionMethodPortal {
    ...
    /* loaded from: discord:lombok/eclipse/agent/PatchExtensionMethodPortal$Reflection.SCL.lombok */
