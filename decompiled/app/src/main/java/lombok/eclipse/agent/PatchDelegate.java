...
/* loaded from: discord:lombok/eclipse/agent/PatchDelegate.SCL.lombok */
public class PatchDelegate {
    ...
    /* loaded from: discord:lombok/eclipse/agent/PatchDelegate$CantMakeDelegates.SCL.lombok */
    public static class CantMakeDelegates extends Exception {
        public Set<String> conflicted;
    }

    /* loaded from: discord:lombok/eclipse/agent/PatchDelegate$ClassScopeEntry.SCL.lombok */
    ...
    /* loaded from: discord:lombok/eclipse/agent/PatchDelegate$1.SCL.lombok */
        ...
        for (BindingTuple pair : methods) {
            ...
            if (method != null) {
                ...
                if (delegateSourceMethods != null) {
                    delegateSourceMethods.add(DelegateSourceMethod.access$0(sourceType, method));
                }
            }
        }
    }
    ...
    /* loaded from: discord:lombok/eclipse/agent/PatchDelegate$TypeVarFinder.SCL.lombok */
    ...
    /* loaded from: discord:lombok/eclipse/agent/PatchDelegate$EclipseTypeBindingScanner.SCL.lombok */
    ...
    /* loaded from: discord:lombok/eclipse/agent/PatchDelegate$DelegateSourceMethod.SCL.lombok */
    private static final class DelegateSourceMethod extends SourceMethod {
        private DelegateSourceMethodInfo sourceMethodInfo;

        static /* synthetic */ DelegateSourceMethod access$0(JavaElement javaElement, MethodDeclaration methodDeclaration) {
        ...
        /* loaded from: discord:lombok/eclipse/agent/PatchDelegate$DelegateSourceMethod$DelegateSourceMethodInfo.SCL.lombok */
    ...
    /* loaded from: discord:lombok/eclipse/agent/PatchDelegate$Reflection.SCL.lombok */
    ...
    /* loaded from: discord:lombok/eclipse/agent/PatchDelegate$DelegateRecursion.SCL.lombok */
            ...
            if (anns != null) {
                for (AnnotationBinding ann : anns) {
                    ...
                    if (name != null && name.length >= 2 && name.length <= 3 && Arrays.equals(STRING_LOMBOK, name[0]) && Arrays.equals(STRING_DELEGATE, name[name.length - 1]) && (name.length != 3 || Arrays.equals(STRING_EXPERIMENTAL, name[1]))) {
                        throw new DelegateRecursion(parent.readableName(), b2.readableName());
                    }
                }
            }
        }
    ...
    /* loaded from: discord:lombok/eclipse/agent/PatchDelegate$BindingTuple.SCL.lombok */
    ...
    /* loaded from: discord:lombok/eclipse/agent/PatchDelegate$DelegateReceiver.SCL.lombok */
    private static abstract class DelegateReceiver {
        ...
        /* loaded from: discord:lombok/eclipse/agent/PatchDelegate$DelegateReceiver$1.SCL.lombok */
        ...
        /* loaded from: discord:lombok/eclipse/agent/PatchDelegate$DelegateReceiver$2.SCL.lombok */
