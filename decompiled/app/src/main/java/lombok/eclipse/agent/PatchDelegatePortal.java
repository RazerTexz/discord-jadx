...
/* loaded from: discord:lombok/eclipse/agent/PatchDelegatePortal.SCL.lombok */
public class PatchDelegatePortal {
    ...
    /* loaded from: discord:lombok/eclipse/agent/PatchDelegatePortal$Reflection.SCL.lombok */
