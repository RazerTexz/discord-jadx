...
/* loaded from: discord:lombok/eclipse/agent/PatchExtensionMethod.SCL.lombok */
public class PatchExtensionMethod {
    ...
    /* loaded from: discord:lombok/eclipse/agent/PatchExtensionMethod$PostponedError.SCL.lombok */
    private interface PostponedError {
        void fire();
    }

    /* loaded from: discord:lombok/eclipse/agent/PatchExtensionMethod$Extension.SCL.lombok */
    ...
    /* loaded from: discord:lombok/eclipse/agent/PatchExtensionMethod$PostponedNoMethodError.SCL.lombok */
    ...
    /* loaded from: discord:lombok/eclipse/agent/PatchExtensionMethod$PostponedInvalidMethodError.SCL.lombok */
    ...
    /* loaded from: discord:lombok/eclipse/agent/PatchExtensionMethod$PostponedNonStaticAccessToStaticMethodError.SCL.lombok */
                                ...
                                for (int i = 0; i < iend; i++) {
                                    ...
                                    if (arg.resolvedType != null) {
                                        if (!param.isBaseType() && arg.resolvedType.isBaseType()) {
                                            int id2 = arg.resolvedType.id;
                                            arg.implicitConversion = 512 | (id2 + (id2 << 4));
                                        } else if (param.isBaseType() && !arg.resolvedType.isBaseType()) {
                                            int id3 = parameters[i].id;
                                            arg.implicitConversion = 1024 | (id3 + (id3 << 4));
                                        }
                                    }
                                }
    ...
    /* loaded from: discord:lombok/eclipse/agent/PatchExtensionMethod$Reflection.SCL.lombok */
