...
/* loaded from: discord:lombok/eclipse/EclipseAST.SCL.lombok */
public class EclipseAST extends AST<EclipseAST, EclipseNode, ASTNode> {
    ...
    protected /* bridge */ /* synthetic */ LombokNode buildTree(ASTNode aSTNode, AST.Kind kind) {
        return buildTree2(aSTNode, kind);
    }
    ...
    /* loaded from: discord:lombok/eclipse/EclipseAST$EclipseWorkspaceBasedFileResolver.SCL.lombok */
    ...
    /* loaded from: discord:lombok/eclipse/EclipseAST$ParseProblem.SCL.lombok */
    class ParseProblem {
    ...
    /* loaded from: discord:lombok/eclipse/EclipseAST$EcjReflectionCheck.SCL.lombok */
