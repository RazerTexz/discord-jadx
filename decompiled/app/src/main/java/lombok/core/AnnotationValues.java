...
/* loaded from: discord:lombok/core/AnnotationValues.SCL.lombok */
public class AnnotationValues<A extends Annotation> {
    ...
    /* loaded from: discord:lombok/core/AnnotationValues$AnnotationValue.SCL.lombok */
    ...
    /* loaded from: discord:lombok/core/AnnotationValues$AnnotationValueDecodeFail.SCL.lombok */
    ...
    /* loaded from: discord:lombok/core/AnnotationValues$1.SCL.lombok */
    class AnonymousClass1 implements InvocationHandler {
        ...
        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            AnnotationValue v = (AnnotationValue) AnnotationValues.access$0(AnnotationValues.this).get(method.getName());
            if (v == null) {
            ...
            while (it.hasNext()) {
                Object guess = it.next();
                Object result = guess == null ? null : AnnotationValues.access$2(AnnotationValues.this, guess, expected, v, idx);
                if (!isArray) {
                    if (result == null) {
