...
/* loaded from: discord:lombok/core/handlers/HandlerUtil.SCL.lombok */
public class HandlerUtil {
    ...
    /* loaded from: discord:lombok/core/handlers/HandlerUtil$FieldAccess.SCL.lombok */
    ...
    public static String camelCaseToConstant(String fieldName) {
        ...
        b2.append(Character.toUpperCase(fieldName.charAt(0)));
        for (int i = 1; i < fieldName.length(); i++) {
            char c = fieldName.charAt(i);
            if (Character.isUpperCase(c)) {
                b2.append('_');
            }
            b2.append(Character.toUpperCase(c));
        }
        return b2.toString();
    }
