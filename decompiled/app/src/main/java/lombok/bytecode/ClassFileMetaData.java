...
/* loaded from: discord:lombok/bytecode/ClassFileMetaData.SCL.lombok */
    ...
    private String decodeString(int pos, int size) {
        ...
        while (pos < end) {
            ...
            if (first < 128) {
                ...
                int x2 = (first & 31) << 6;
                pos++;
                int y2 = this.byteCode[pos] & 63;
                int i3 = length;
                length++;
                result[i3] = (char) (x2 | y2);
            } else {
                int x3 = (first & 15) << 12;
                int pos2 = pos + 1;
                int y3 = (this.byteCode[pos] & 63) << 6;
                pos = pos2 + 1;
                int z2 = this.byteCode[pos2] & 63;
                int i4 = length;
                length++;
                result[i4] = (char) (x3 | y3 | z2);
            }
        }
