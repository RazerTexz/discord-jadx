...
/* loaded from: discord:org/objectweb/asm/tree/analysis/SmallSet.SCL.lombok */
final class SmallSet<T> extends AbstractSet<T> {
    ...
    /* loaded from: discord:org/objectweb/asm/tree/analysis/SmallSet$IteratorImpl.SCL.lombok */
